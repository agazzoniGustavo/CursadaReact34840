...
const Checkout = () => {
    ...
    const generarOrden = () => {
        ...
        addDoc(ordersCollection, order).then((snapShot) => {
            ...
            const orderDoc = doc(db, "orders", snapShot.id); //BUSACAR DOCUMENTO POR ID
            updateDoc(orderDoc, {total: order.total * 0.9}); //ACTUALIZAR DOCUMENTO

            // BATCH DE ACTUALIZACIÓN, EJEMPLO, NO UTIL POR AHORA
        ...
        <div className="container">
            <div className="row my-5">
                <div className="col">
                    <form>
                        ...
                        <button type="button" onClick={generarOrden} class="btn fondoRosa">Generar Orden</button>
                    </form>
                </div>
                <div className="col">
                    <table class="table">
            ...
            <div className="row my-5">
                <div className="col text-center">
                    {orderId ? <div class="alert alert-danger" role="alert">
